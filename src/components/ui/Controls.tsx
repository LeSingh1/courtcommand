...
export function TextInput({
  ...
  return (
    <input
      ...
      className="w-full rounded-none border border-white/10 bg-white/[0.04] px-3 py-2.5 text-sm text-white outline-none transition placeholder:text-white/30 focus:border-white/25"
    />
  );
}
