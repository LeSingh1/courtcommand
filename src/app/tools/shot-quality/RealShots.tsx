            ...
            {filtered.map((sp) => {
              ...
              return (
                <button
                  ...
                  style={{
                    borderColor: sel ? "#4D8DFF66" : "transparent",
                    background: sel ? "#4D8DFF12" : "transparent",
                  }}
                >
            ...
            {shots.map((s) => {
              ...
              return (
                <button
                  ...
                  style={{
                    borderColor: sel ? "#4D8DFF66" : "var(--line)",
                    background: sel ? "#4D8DFF12" : "transparent",
                  }}
                >
                  <span
                    className="flex h-5 w-5 items-center justify-center"
                    style={{ background: s.made ? "#4D8DFF" : "transparent", border: s.made ? "none" : "1px solid #F4647D55" }}
                  >
                ...
                <Panel>
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3">
                    ...
                    <div
                      ...
                      style={{
                        borderColor: shot.made ? "#4D8DFF55" : "#F4647D55",
                        background: shot.made ? "#4D8DFF0f" : "#F4647D0f",
                      }}
                    >
                      <div className="kicker mb-1">Reality</div>
                      <div className="scoreboard text-2xl" style={{ color: shot.made ? "#4D8DFF" : "#F4647D" }}>
                        {shot.made ? "MADE" : "MISS"}
                      </div>
